...
data = [
    {
        name: "Beau Wilson",
        points_single: 100,
        criteria: ["Respect", "Responsibility", "Readiness", "The secret 4th R", "FIVE Rs!!11!one!"],
        points_multiple: [
            { subject: "One", points: 100, points_criteria: [100, 100, 100, 100] },
            { subject: "Two", points: 100, points_criteria: [100, 100, 100, 100] },
            { subject: "Three", points: 100, points_criteria: [100, 100, 100, 100] },
            { subject: "Four", points: 100, points_criteria: [100, 100, 100, 100] },
            { subject: "Five", points: 100, points_criteria: [100, 100, 100, 100] },
            { subject: "Six", points: 100, points_criteria: [100, 100, 100, 100] },
            { subject: "Seven", points: 100, points_criteria: [100, 100, 100, 100] },
            { subject: "Eight", points: 100, points_criteria: [100, 100, 100, 100] },
            { subject: "Nine", points: 100, points_criteria: [100, 100, 100, 100] },
            { subject: "Ten", points: 100, points_criteria: [100, 100, 100, 100] },
        ]
    }
]
*/
...
function CreateNameElement(name, value, parent) {
    ...
    entry.classList.add("beau-ui", "entry");
...
function UpdateChanger(mode = "single") {
    ...
    if (UserSettings.system.SystemToUse == "colors") {
        ...
        container.classList.add("beau-ui");
    ...
    for (i = 0; i < 2; i++) {
        ...
        circle = document.createElement("button");
        circle.classList.add("changer-circle", "beau-ui");
...
function UpdateClipsView() {
    ...
    if (UserSettings.clips.Categories.length == 0 || (UserSettings.clips.Categories.length == 1 && !UserSettings.clips.Categories[0].length)) {
        ...
        NoCategoriesDiv.classList.add("beau-ui");
    ...
    ClipsViewBuffer.classList.add("beau-ui");
...
function ViewNamePoints(name) {
    ...
    database.transaction(["names"], "readwrite").objectStore("names").get(name).onsuccess = (event) => {
        ...
        NameViewBuffer.classList.add("beau-ui");
        row = document.createElement("tr");
